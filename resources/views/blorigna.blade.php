    ...
    <div class="container">
        ...
        <form id="loanApplicationForm" class="row mt-3" method="post" action="http://192.168.0.231/loancrm/api/cutomer-data-wp-bl-post">
            ...
            <div class="col-md-4 form-group">
                    ...
                    <input type="text" name="first_name" id="name" class="form-control" placeholder="Enter Name" required>
            ...
            <div class="col-md-4 form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" placeholder="XXXXXXXXX" class="form-control amount required" name="loan_amount" data-validation="required number" data-validation-error-msg="Please enter a valid loan amount" id="loan_amount" tabindex="1" value="" >
                </div>
            </div>
            ...
            <div class="form-group col-sm-4">
                ...
                <select title="Select your employment" class="" id="employment_type_id" name="employment_type_id" data-validation="required" data-validation-error-msg="" tabindex="4" autocomplete="Off" onchange="toggleEmploymentFields()">
            ...
            <div class="form-group col-sm-4 has-error" id="annual-turnover" style="display: block;">
                ...
                <div class="input-group">
                    <span class="input-group-addon">Rs</span>
                    <select title="Select Turnover" class="" name="annual_turnover" id="annual_turnover" data-validation="required" data-validation-error-msg="Please enter the annual turnover" tabindex="7" autocomplete="Off" aria-hidden="true" onchange="toggleBasicInformationFields()">
            ...
            <div class="form-group col-sm-4" id="years-in-business" style="display: ;">
                ...
                <input type="number" class="form-control" name="years_in_business" tabindex="9" autocomplete="Off" placeholder="Years In Current Business/Profession">
            </div>
            ...
            <div id="contract-view">
                ...
                By submitting this form, you have read and agree to the<a href="" class="clr-blue4 TdecorN"> </a><a href="" class=""> Terms of Use </a> &amp; <a href="" target="">Privacy Policy </a></div>
